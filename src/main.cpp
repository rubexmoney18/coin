...
uint256 hashGenesisBlock("0x82a18ba6d3b80ced87380ced424c3eca2b426310cd991fde3fe77d5900b11fea");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Rubex: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Rubex Signed Message:\n";
...
{
    // Rubex: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    int64 nSubsidy = 5 * nCoin;

   if(nHeight == 50){

           return 31999010 * nCoin + nFees;
    }
...
static const int64 nTargetSpacing = 150; // Rubex: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Rubex: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Rubex: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Rubex: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x01f8143b0ad848fead1d0e9f34db453047727f907de34980f8d539fbbfc8ed90");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("690efb81a7b35862b064212b20e82e5ce9bae144ec24eb873a006a29e5291b87f900661ee64507a32c646b65fed80471591e9713721e8b93e8627c0c8331bc6579") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1518423925;
        block.nBits    = 504365644;
        block.nNonce   = 68322579;

        if (fTestNet)
        {
            block.nTime    = 1518423925;
            block.nNonce   = 3598991937;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x650ab4b7c6dba07e92ef566ebf4c68c2fd59a504f3643879299d1469a76c8a3d"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Rubex: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("RubexMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("RubexMiner : ProcessBlock, block not accepted");
    }
